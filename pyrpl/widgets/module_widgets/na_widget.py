...
class NaWidget(AcquisitionModuleWidget):
    ...
    def init_gui(self):
        ...
        self.win = pg.GraphicsLayoutWidget(title="Magnitude", show=True)
    ...
    def x_log_toggled(self):
        ...
        for chunk, chunk_phase in zip(self.chunks, self.chunks_phase):
            chunk.setLogMode(xState=log_mod, yState=None)
            chunk_phase.setLogMode(xState=log_mod, yState=None)
