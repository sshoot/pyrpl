...
class OutputSignalWidget(ModuleWidget):
    ...
    def init_gui(self):
        ...
        self.win = pg.GraphicsLayoutWidget(title="Amplitude", show=True)
        self.win_phase = pg.GraphicsLayoutWidget(title="Phase", show=True)
        ...
        self.curve.setLogMode(xState=True, yState=True)
        self.curve_phase.setLogMode(xState=True, yState=None)
...
class LockboxInputWidget(ModuleWidget):
    ...
    def init_gui(self):
        ...
        self.win = pg.GraphicsLayoutWidget(title="Expected signal", show=True)
